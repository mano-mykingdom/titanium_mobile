...
public class TiTimePickerDialog extends TimePickerDialog
{
	...
	public TiTimePickerDialog(Context context, int theme, OnTimeSetListener callBack, int hourOfDay, int minute,
							  boolean is24HourView)
	{
	...
	public void onAttachedToWindow()
	{
		...
		if (TIME_PICKER_INTERVAL != 1) {
			try {
				...
				TimePicker timePicker = (TimePicker) findViewById(timePickerField.getInt(null));
